/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 1beaaae3473f22686e43cb167c991e2d)
// Runtime types generated with workerd@1.20251210.0 2025-12-28 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PlayAgent";
	}
	interface Env {
		CACHE: KVNamespace;
		AI_PROVIDER: "gemini";
		...
		AI: Ai;
		GAME_GENERATION_WORKFLOW: Workflow<Parameters<import("./src/index").GameGenerationWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_PROVIDER" | "AI_MODEL" | "GEMINI_API_KEY">> {}
}
